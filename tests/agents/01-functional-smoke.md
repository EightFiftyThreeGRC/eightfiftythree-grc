...
3. Program setup wizard: complete all 7 steps (Organization → Program → Reg mapping → PM Controls → InfoSec Policy → Policy set → Assign Owners) with minimal valid inputs; `cisoComplete` becomes true; Command Center appears.
